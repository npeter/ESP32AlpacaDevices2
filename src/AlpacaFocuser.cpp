...
bool const AlpacaFocuser::_getDeviceStateList(size_t buf_len, char *buf)
{
    size_t snprintf_result =
        snprintf(buf, buf_len, "{\"Name\":\"IsMoving\",\"Value\":%s},{\"Name\":\"Position\",\"Value\":%d},{\"Name\":\"Temperature\",\"Value\":%f},{\"Name\":\"TempCompAvailable\",\"Value\":%s},{\"Name\":\"Connected\",\"Value\":true}",
                 _getIsMoving() ? "true" : "false",
                 _getPosition(),
                 _getTemperature(),
                _getTempCompAvailable()==true ? "true" : "false");
